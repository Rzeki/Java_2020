...
public class TicTacToe extends JFrame {
    ...
    private Integer res; //ROZMIAR TABLICY res x res
    private Integer movesToWin; //Liczba pól do zwyciestwa
    private Container pane;
    private String currentPlayer;
    private JButton[][] board; //TABLICA PRZYCISKÓW
    private boolean End;
    ...
    private void hasWinner(String currentPlayer) 
    {
        int rekord=0;
        int current=1;
        for(int i=0;i<res;i++)
